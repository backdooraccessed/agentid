      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert prose-white/70 max-w-none space-y-8">
          ...
          <section>
            ...
            <h3 className="text-lg font-medium text-white mt-6 mb-3">Credential Data</h3>
            <ul className="list-disc list-inside text-white/70 space-y-2">
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">We use collected information to:</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-white/70 space-y-2 mt-4">
              <li><strong className="text-white">Service Providers:</strong> Third parties that help us operate the Service</li>
              <li><strong className="text-white">Verification Requests:</strong> Public credential data when verification is requested</li>
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">Depending on your location, you may have the right to:</p>
            <ul className="list-disc list-inside text-white/70 space-y-2 mt-4">
          ...
          <section>
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              <a href="mailto:privacy@agentid.dev" className="text-white underline underline-offset-2">
                privacy@agentid.dev
              </a>
            </p>
          </section>
